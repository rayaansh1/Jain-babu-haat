        ...
        <div style={{ padding: '20px 18px', borderBottom: '1px solid rgba(201,151,58,0.15)' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 14 }}>
            ...
            <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: 15, fontWeight: 700, color: '#0f2a4a', lineHeight: 1.5 }}>
              श्री जय नारायण सिंह के सम्मान में – सेवा और ग्रामीण विकास की जीवित विरासत
            </h3>
          </div>
          {[
            'जैन बाबू हाट की स्थापना <strong>श्री जय नारायण सिंह</strong> के प्रति गहरे सम्मान और उनके जीवनभर के समर्पण को मान्यता देने के उद्देश्य से की गई है। यह केवल एक बाजार नहीं है, बल्कि उनके विचारों, उनकी दृष्टि और गांव के विकास के प्रति उनके निरंतर प्रयासों का प्रतीक है।',
            'इस पहल की स्थापना वर्ष 2020 में <strong>श्री शैलेन्द्र नारायण सिंह</strong> द्वारा की गई, जिनका उद्देश्य पारंपरिक ग्रामीण बाजारों को एक संगठित, सुलभ और स्थायी आर्थिक केंद्र के रूप में विकसित करना था। उनके प्रयासों ने इस विचार को एक मजबूत दिशा और संरचना प्रदान की।',
            'श्री जय नारायण सिंह ने हमेशा अपने गांव और समाज के कल्याण को प्राथमिकता दी है। उनका जीवन सादगी, ईमानदारी और समावेशिता का उदाहरण है। वे मानते हैं कि वास्तविक विकास जमीनी स्तर से शुरू होता है, और उनके कार्य इसी सोच को दर्शाते हैं।',
            ...
            'इस बाजार का नाम श्री जय नारायण सिंह के नाम पर रखना उनके प्रति सम्मान और कृतज्ञता का प्रतीक है। विशेष रूप से यह सम्मान उनके जीवनकाल में दिया जाना इसे और भी महत्वपूर्ण बनाता है।',
